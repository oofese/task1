    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title:Text( "ADD TODO",style: TextStyle(fontStyle: FontStyle.normal,),),
          centerTitle: true,
          leading: IconButton(
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              TextFormField(controller: _title, decoration: InputDecoration(
                ...
                hintStyle: TextStyle(fontStyle: FontStyle.normal,color: Colors.black),
                filled: true,
                fillColor: Colors.blue[50],
              ),),
              CustomText(text: 'description'.toUpperCase()),
              TextFormField(controller: _description, decoration: InputDecoration(
                enabledBorder: OutlineInputBorder(
                  borderSide: BorderSide(color: Colors.transparent),
                  borderRadius: BorderRadius.circular(5.5),
                ),
                ...
                hintStyle: GoogleFonts.didactGothic(color: Colors.black),
                filled: true,
                fillColor: Colors.blue[50],
              ),),
